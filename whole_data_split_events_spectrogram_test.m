...
time_data = 'D:\Howard_Feng\georgia_tech\time_stemp\G_Tech_Data_Analysis\time_stemp_whole.csv';

raw_data_path = 'D:\Howard_Feng\georgia_tech\time_stemp\G_Tech_Data_Analysis\whole_data';
...
resize_val = [50 * 32, 45 * 32, 58 * 32, 10 * 32, 32 * 32];
...
mkdir('D:\Howard_Feng\georgia_tech\time_stemp\G_Tech_Data_Analysis\whole_data', 'Figures_spectrogram_range64_filter32');
...
%             'bicubic');
        ...
        save_folder = ...
            sprintf('D:\\Howard_Feng\\georgia_tech\\time_stemp\\G_Tech_Data_Analysis\\whole_data\\Figures_spectrogram_range64_filter32\\Event_%d\\', event_num);
